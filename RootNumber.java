public class RootNumber extends AbstractMathObject<RootNumber>{
    ...
    @Override
    RootNumber sendValue(long a) {
        return new RootNumber(a);
    }

    @Override
    RootNumber sendValue(long a, long b) {
        return new RootNumber(a, b, 1);
    }

    @Override
    RootNumber[] sendValues(long[] a) {
    ...
    @Override
    RootNumber sendRandomValue(int limit) {
