...
public class Fraction extends AbstractMathObject<Fraction> {
    ...
    public Fraction sqrt() {
        throw new IllegalStateException("Attempted sqrt(). Use NumberTypes.RootFraction instead");
    }
    ...
    public Fraction sendValue(long a){
        return new Fraction(a);
    }

    @Override
    public Fraction sendValue(long a, long b) {
        return new Fraction(a,b);
    }

    @Override
    public Fraction[] sendValues(long[] a) {
    ...
    public Fraction sendRandomValue(int limit){
