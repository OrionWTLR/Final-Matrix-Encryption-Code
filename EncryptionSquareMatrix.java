...
class EncryptionSquareMatrix<E extends AbstractMathObject<E>> extends Encryption<E> {
    private final SquareMatrix<E> CodingMatrix;
    private final int prime;
    private final E PRIME;
    private final E access;
    private final int PHI = 73;

    EncryptionSquareMatrix(E acc){
...
/*        double[][] primCodingMatrix = {
        ...
        access = acc;
        CodingMatrix = new SquareMatrix<>(primCodingMatrix, access);
        prime = 87;
        PRIME = access.sendValue(prime);
    }

    String oneWayHash(String plaintext){
        SquareMatrix<E> A = CodingMatrix.copy();
    ...
    String decrypt(String ciphertext){
        ...
        SquareMatrix<E> invA = CodingMatrix.copy(); invA.inverse();
